...
FakeResponses = {'/opt/compaq/hpacucli/bld/hpacucli controller all show': 'testdata/hpsa/1.txt',
                 ...
                 '/opt/compaq/hpacucli/bld/hpacucli controller slot=0 logicaldrive 1 show': 'testdata/hpsa/30.txt',
                 '/opt/compaq/hpacucli/bld/hpacucli controller slot=2 logicaldrive 1 show': 'testdata/hpsa/31.txt',
                 '/usr/sbin/smartctl -x -d cciss,0 /dev/sda': 'testdata/hpsa/smart/1.txt',
                 '/usr/sbin/smartctl -x -d cciss,1 /dev/sda': 'testdata/hpsa/smart/2.txt',
                 '/usr/sbin/smartctl -x -d cciss,2 /dev/sda': 'testdata/hpsa/smart/3.txt',
                 '/usr/sbin/smartctl -x -d cciss,3 /dev/sda': 'testdata/hpsa/smart/4.txt',
                 '/usr/sbin/smartctl -x -d cciss,4 /dev/sda': 'testdata/hpsa/smart/5.txt',
                 '/usr/sbin/smartctl -x -d cciss,5 /dev/sda': 'testdata/hpsa/smart/6.txt',
                 '/usr/sbin/smartctl -x -d cciss,6 /dev/sda': 'testdata/hpsa/smart/7.txt',
                 '/usr/sbin/smartctl -x -d cciss,7 /dev/sda': 'testdata/hpsa/smart/8.txt',
                 '/usr/sbin/smartctl -x -d cciss,8 /dev/sda': 'testdata/hpsa/smart/9.txt',
                 '/usr/sbin/smartctl -x -d cciss,0 /dev/sdb': 'testdata/hpsa/smart/10.txt',
                 '/usr/sbin/smartctl -x -d cciss,1 /dev/sdb': 'testdata/hpsa/smart/11.txt',
                 '/usr/sbin/smartctl -x -d cciss,2 /dev/sdb': 'testdata/hpsa/smart/12.txt',
                 '/usr/sbin/smartctl -x -d cciss,3 /dev/sdb': 'testdata/hpsa/smart/13.txt',
                 '/usr/sbin/smartctl -x -d cciss,4 /dev/sdb': 'testdata/hpsa/smart/14.txt',
                 '/usr/sbin/smartctl -x -d cciss,5 /dev/sdb': 'testdata/hpsa/smart/15.txt',
                 '/usr/sbin/smartctl -x -d cciss,6 /dev/sdb': 'testdata/hpsa/smart/16.txt',
                 '/usr/sbin/smartctl -x -d cciss,7 /dev/sdb': 'testdata/hpsa/smart/17.txt',
                 '/usr/sbin/smartctl -x -d cciss,8 /dev/sdb': 'testdata/hpsa/smart/18.txt',
                 '/usr/sbin/smartctl -x -d cciss,9 /dev/sdb': 'testdata/hpsa/smart/19.txt',
                 '/usr/sbin/smartctl -x -d cciss,10 /dev/sdb': 'testdata/hpsa/smart/20.txt',
                 '/usr/sbin/smartctl -x -d cciss,11 /dev/sdb': 'testdata/hpsa/smart/21.txt',
                 '/usr/sbin/smartctl -x -d cciss,12 /dev/sdb': 'testdata/hpsa/smart/22.txt',
                 '/usr/sbin/smartctl -x -d cciss,9 /dev/sda': 'testdata/hpsa/smart/23.txt',
                 '/usr/sbin/smartctl -x -d cciss,13 /dev/sdb': 'testdata/hpsa/smart/24.txt',
                 '/usr/sbin/smartctl -x -d cciss,14 /dev/sdb': 'testdata/hpsa/smart/25.txt',
}
